...
func (h *Handler) getDevices(c *gin.Context) {
	...
	devices, err := h.services.UserDevice.Get(user_id.(int))
	if err != nil {
...
func (h *Handler) addDevice(c *gin.Context) {
	...
	device, err := h.services.UserDevice.Add(user_id.(int), deviceRequest.Uid)
	if err != nil {
		newErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
...
func (h *Handler) deleteDevice(c *gin.Context) {
	...
	err := h.services.UserDevice.Delete(user_id.(int), device_id)
	if err != nil {
		newErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
